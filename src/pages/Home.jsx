...
function Home() {
    return (
        <div>
                    ...
                    <CodeBlocks 
                        ...
                        heading={
                            <div className="text-4xl font-semibold">
                                Unlock your
                                <HighlighText text={"coding potential"} /> with our online courses.
                            </div>
                        }
                        subheading={
                            "Our courses are designed and taught by industry specialist who have years of experience in coding and are passionate about sharing their knowledge with you."
                        }
                        ctabtn1={{
            ...
            {/* Full Catalog & Learn More Buttons */}
            <div className="bg-pure-greys-5 text-richblack-700">
                <div className="homepage_bg h-[320px]">
                    <div className="mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8">
                        <div className="lg:h-[150px]"></div>
                        <div className="flex flex-row gap-7 text-white lg:mat-8">
                            <CTAButton active={true} linkto={"/signup"}>
